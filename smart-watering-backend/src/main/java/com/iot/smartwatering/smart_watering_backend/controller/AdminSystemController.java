...
import com.iot.smartwatering.smart_watering_backend.dto.response.SystemStatisticsResponse;
...
public class AdminSystemController {
        ...
        public ResponseEntity<ApiResponse<SystemStatisticsResponse>> getSystemStatistics() {
                SystemStatisticsResponse stats = SystemStatisticsResponse.builder()
                                ...
                                .offlineDevices((long) deviceRepository.findByStatus(Device.DeviceStatus.OFFLINE)
                                                .size())

                                // Alert statistics
                                .totalAlerts(alertRepository.count())
                                .unhandledAlerts((long) alertRepository.findByIsHandledFalseOrderByCreatedAtDesc()
                                                .size())
                                .criticalAlerts((long) alertRepository
                                                .findBySeverityOrderByCreatedAtDesc(Alert.AlertSeverity.CRITICAL)
                                                .size())
        ...
        public ResponseEntity<ApiResponse<String>> cleanupOldSensorData(
                ...
                List<com.iot.smartwatering.smart_watering_backend.entity.SensorData> oldData = sensorDataRepository
                                .findAll().stream()
        ...
        private Map<String, Object> mapZoneToMap(Zone zone) {
                ...
                map.put("thresholdMin", zone.getThresholdMin());
                map.put("thresholdMax", zone.getThresholdMax());
                ...
                map.put("deviceCount", zone.getDevice() != null ? 1 : 0);
                return map;
        }
        ...
        private AlertResponse mapToAlertResponse(Alert alert) {
                return AlertResponse.builder()
                                ...
                                .handledByUsername(alert.getHandledBy() != null ? alert.getHandledBy().getUsername()
                                                : null)
